    ...
    <section ref={ref} id="skills" className="w-full max-w-5xl scroll-mt-28 mb-28 sm:mb-36">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {groups.map(([name, skills], i) => (
          <motion.div key={name as string} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="terminal-panel rounded-xl p-5">
